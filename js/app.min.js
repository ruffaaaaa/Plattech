...
var TrandingSlider = new Swiper('.tranding-slider', {
  ...
  const photos = document.querySelectorAll('.photo-slideshow .photo');
		let currentPhoto = 0;
